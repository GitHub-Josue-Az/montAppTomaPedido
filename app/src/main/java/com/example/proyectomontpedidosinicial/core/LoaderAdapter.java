...
public abstract class LoaderAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int posicion) {
        ...
        if (viewHolder instanceof LoaderViewHolder) {
            LoaderViewHolder loaderViewHol = (LoaderViewHolder) viewHolder;
            if (showLoader) {
                loaderViewHol.progressb.setVisibility(View.VISIBLE);
            } else {
                loaderViewHol.progressb.setVisibility(View.GONE);
            }
            return;
        }
