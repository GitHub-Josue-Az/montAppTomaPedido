package com.gob.proyectomontpedidosinicial.data.constans;



public class Constans {
    public static final String NAME_TABLE_ENTITY_CLIENTE= "entitycliente";
    public static final String NAME_TABLE_ENTITY_CONDICION_PAGO = "entitycondicionpago";
