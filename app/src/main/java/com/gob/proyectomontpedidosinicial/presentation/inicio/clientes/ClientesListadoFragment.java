package com.gob.proyectomontpedidosinicial.presentation.inicio.clientes;
...
public class ClientesListadoFragment extends BaseFragment{

    private static final String TAG = ClientesListadoFragment.class.getSimpleName();
    ...
    public ClientesListadoFragment() {
    }
    ...
    public static ClientesListadoFragment newInstance() {
        return new ClientesListadoFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_clientes_listado, container, false);
